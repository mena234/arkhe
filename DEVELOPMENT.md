...
[Back to the project overview](README.md) · [Live demo](https://arkhe-materials.ramzy.tech/)
...
The active deployment uses **Sites + Cloudflare Workers, D1, R2, and dispatch-owned ChatGPT sign-in**. This is the supported, tested deployment target. Supabase is an optional separate port, not the active hosted backend.
